...
def Translate(targetLanguage):
    ...
    # Translate speech
    audio_config_in = speech_sdk.AudioConfig(use_default_microphone=True) # Using default microphone
    ...
    audio_config_out = speech_sdk.audio.AudioOutputConfig(use_default_speaker=True) # Use default speaker
